        ...
        <div class="space-y-5">
            <x-card>
                ...
                <div x-show="lang==='ru'" x-cloak class="space-y-4">
                    <div><label class="fin-label">Заголовок (RU)</label><input name="title_ru" type="text" class="fin-input" value="{{ old('title_ru', $post->title_ru) }}"></div>
                    <div><label class="fin-label">Анонс (RU)</label><textarea name="excerpt_ru" rows="2" class="fin-input">{{ old('excerpt_ru', $post->excerpt_ru) }}</textarea></div>
                    <div><label class="fin-label">Текст (RU)</label>@include('admin.blog._editor', ['content' => $post->body_ru, 'name' => 'body_ru', 'placeholder' => 'Напишите статью…'])</div>
                </div>
            ...
            <x-card title="SEO та мета-теги">
                ...
                <div x-show="lang==='ru'" x-cloak class="space-y-4">
                    <x-blog-seo-field name="meta_title_ru" label="Meta Title (RU)" :max="60" :value="old('meta_title_ru', $post->meta_title_ru)" />
                    <x-blog-seo-field name="meta_description_ru" type="textarea" label="Meta Description (RU)" :max="160" :value="old('meta_description_ru', $post->meta_description_ru)" />
                </div>
            </x-card>
        </div>
