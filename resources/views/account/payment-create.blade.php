...
@if(session('created_invoice'))
    ...
    <div x-data="{
        ...
        <div x-show="open" x-transition class="relative max-h-[92vh] w-full max-w-lg overflow-y-auto rounded-3xl border border-slate-200 bg-white p-6 shadow-2xl [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:p-7">
            ...
            <div class="mt-5 flex flex-col items-center gap-4 rounded-2xl bg-slate-50 p-5">
                <div x-ref="qrbox" class="flex justify-center rounded-2xl border border-slate-200 bg-white p-3 [&>svg]:block"></div>
