...
<div class="space-y-6"
    ...
    <form method="POST" action="{{ route('account.settings.notifications.update') }}">
        @csrf
        @foreach(['channel_email', 'channel_telegram', 'event_auth', 'event_withdraw', 'event_partial', 'event_paid'] as $k)
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div class="grid grid-cols-2 gap-4">
                    @foreach(['event_auth' => __('account.settings.event_auth'), 'event_partial' => __('account.settings.event_partial'), 'event_withdraw' => __('account.settings.event_withdraw'), 'event_paid' => __('account.settings.event_paid')] as $k => $label)
