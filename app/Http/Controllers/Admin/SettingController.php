        ...
        return [
            ...
            'blockchain' => [
                ...
                'fields' => [
                    ...
                    'etherscan_api_key' => ['type' => 'password', 'label' => 'Etherscan API key (V2 — ETH + Arbitrum/Optimism/Base)', 'default' => '', 'encrypted' => true, 'placeholder' => ''],
                    'bscscan_api_key'   => ['type' => 'password', 'label' => 'BscScan API key (BEP-20)', 'default' => '', 'encrypted' => true, 'placeholder' => ''],
                    'solana_deposit_address' => ['type' => 'text', 'label' => 'Solana — публічна адреса депозитів (спільна, memo)', 'default' => '', 'placeholder' => 'напр. 4Nd1m...'],
                    'solana_node_url'        => ['type' => 'text', 'label' => 'Solana RPC URL', 'default' => '', 'placeholder' => 'https://api.mainnet-beta.solana.com'],
                    'ton_deposit_address'    => ['type' => 'text', 'label' => 'TON — публічна адреса депозитів (спільна, memo/comment)', 'default' => '', 'placeholder' => 'напр. EQC...'],
                    'ton_api_key'            => ['type' => 'password', 'label' => 'TON API key (toncenter — native TON)', 'default' => '', 'encrypted' => true, 'placeholder' => ''],
                    'tonapi_key'             => ['type' => 'password', 'label' => 'tonapi.io key (Jetton-токени, напр. USDT-TON)', 'default' => '', 'encrypted' => true, 'placeholder' => ''],
                ],
            ],
        ];
    }
