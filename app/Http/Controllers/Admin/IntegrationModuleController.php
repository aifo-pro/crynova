...
class IntegrationModuleController extends Controller
{
    ...
    private function validateData(Request $request, ?IntegrationModule $module = null): array
    {
        ...
        return $request->validate([
            ...
            'name_pl'          => ['nullable', 'string', 'max:255'],
            'name_ru'          => ['nullable', 'string', 'max:255'],
            'slug'             => ['nullable', 'string', 'max:255', $uniqueSlug],
            'description'      => ['nullable', 'string', 'max:500'],
            'description_en'   => ['nullable', 'string', 'max:500'],
            'description_pl'   => ['nullable', 'string', 'max:500'],
            'description_ru'   => ['nullable', 'string', 'max:500'],
            'long_description'    => ['nullable', 'string', 'max:20000'],
            'long_description_en' => ['nullable', 'string', 'max:20000'],
            'long_description_pl' => ['nullable', 'string', 'max:20000'],
            'long_description_ru' => ['nullable', 'string', 'max:20000'],
